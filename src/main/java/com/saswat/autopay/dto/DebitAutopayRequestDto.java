...
public class DebitAutopayRequestDto {
	...
	public String toString() {
		return "DebitAutopayRequestDto [key=" + key + ", txnid=" + txnid + ", amount=" + amount + ", productinfo="
				+ productinfo + ", firstname=" + firstname + ", phone=" + phone + ", email=" + email + ", surl=" + surl
				+ ", furl=" + furl + ", hash=" + hash + ", udf1=" + udf1 + ", udf2=" + udf2 + ", udf3=" + udf3
				+ ", udf4=" + udf4 + ", udf5=" + udf5 + ", address1=" + address1 + ", address2=" + address2 + ", city="
				+ city + ", state=" + state + ", country=" + country + ", zipcode=" + zipcode
				+ ", customer_authentication_id=" + customer_authentication_id + ", merchant_debit_id="
				+ merchant_debit_id + ", auto_debit_access_key=" + auto_debit_access_key + ", sub_merchant_id="
				+ sub_merchant_id + "]";
	}
