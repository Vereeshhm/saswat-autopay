...
public class EaseBuzzAutoPayController {
	...
	public ResponseEntity<String> InitiatePay(@RequestParam("amount") Float amount,
		    ...
		    @RequestParam("show_payment_mode") String showPaymentMode)
			throws Exception {
		
		
		RegisterAutopayRequestDto registerAutopayRequestDto = new RegisterAutopayRequestDto();
	    registerAutopayRequestDto.setAmount(amount);
